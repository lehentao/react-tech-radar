...
function Radar(props) {
  ...
  var margin = 5; //some internally used constants
      ...
      _themeContext.ThemeContext.Provider,
      {
        value: {
          ...
          colorScale: props.colorScaleIndex
            ? (0, _themeContext.getColorScale)(props.colorScaleIndex)
            : colorScale
        }
      },
...
Radar.propTypes = {
  ...
  maxLengthText: _propTypes.default.number
};
var _default = Radar;
